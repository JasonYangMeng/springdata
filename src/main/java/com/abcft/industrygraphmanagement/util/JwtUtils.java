...
/**
 * @Author Created by YangMeng on 2021/5/11 14:16
 */
@Slf4j
public class JwtUtils {
     ...
     */
    private final static String secretKey = "graph";
    /**
    ...
    public static String generate(UserEntity userEntity) {
        ...
        return Jwts.builder()
                .setClaims(stringMap)
                .setSubject(loginName) // 将userName放进JWT
    ...
    public static Claims parse(String token) {
        ...
        try {
            ...
            log.error("JwtUtils parse fail:{}", e);
        }
        return claims;
    }
}
